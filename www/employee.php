      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
            <input class="add btn btn-success" type="submit" name="add" id="add" value="เพิ่มพนักงาน" />
            <br/><br/>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>รหัสพนักงาน</th>
                  <th>รหัสผ่านพนักงาน</th>
                  <th>ชื่อพนักงาน</th>
                  <th>นามสกุลพนักงาน</th>
                  <th>เบอร์โทรศัพท์</th>
                  <th>ที่อยู่</th>
                  <th>เวลาเข้าสู่ระบบล่าสุด</th>
                  <th>เวลาออกจากระบบล่าสุด</th>
                  <th></th>
                </tr>
                </thead>

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">การชำระเงินบริษัท</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="col-12">
          ...
          <div class="container-fluid">
             <div align="center"><h4>ร้านขายอุปกรณ์คอมพิวเตอร์ Computer-Store</h4></div>
              ...
              <tr>
              <td>
              <strong>รายงานสรุปการชำระเงินบริษัท <?php if($_POST['date'] != ""){ echo "ตั้งแต่วันที่ ".$_POST['date']; }?></strong>
              </td>

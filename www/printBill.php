  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">การชำระเงินลูกค้า</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="card">
            <div class="container-fluid">
             <div align="center"><h4>ร้านขายอุปกรณ์คอมพิวเตอร์ Computer-Store</h4></div>
              ...
              <tr>
              <td>
              <strong>รายงานสรุปการชำระเงินลูกค้า <?php if($_POST['date'] != ""){ echo "ตั้งแต่วันที่ ".$_POST['date']; }?></strong>
              </td>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                if($_POST['date'] != ""){$result = mysqli_query($con,"SELECT * FROM bill WHERE bill_date BETWEEN '$sdate' AND '$edate'");}else{
                ...
                <tr>
                  ...
                  <td><?php echo number_format($row['bill_price']); ?></td>
                  <td><?php $time=$row['bill_date']; echo Thai_date($time); ?></td>
                </tr>
                </form>
                <?php $count = $count + 1; $allprice = $allprice + intval($row['bill_price']); } mysqli_close($con);?>

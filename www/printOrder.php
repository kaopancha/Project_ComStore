  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">การสั่งซื้อ/ส่งสินค้า</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="col-12">
          ...
          <div class="container-fluid">
             <div align="center"><h4>ร้านขายอุปกรณ์คอมพิวเตอร์ Computer-Store</h4></div>
              ...
              <tr>
              <td>
              <strong>รายงานสรุปการสั่งซื้อสินค้า <?php if($_POST['date'] != ""){ echo "ตั้งแต่วันที่ ".$_POST['date']; }?></strong>
              </td>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                if($_POST['date'] != ""){$result = mysqli_query($con,"SELECT * FROM order_pro WHERE order_date BETWEEN '$sdate' AND '$edate' group by order_id");}
                else{$result = mysqli_query($con,"SELECT * FROM order_pro group by order_id");}
                ...
                <tr>
                  ...
                  <td>
                      ...
                      $result3 = mysqli_query($con,"SELECT * FROM order_pro WHERE order_id = '$order_id'");
                  ...
                  <td>
                      ...
                      $result3 = mysqli_query($con,"SELECT * FROM order_pro WHERE order_id = '$order_id'");
                      while($row3 = mysqli_fetch_assoc($result3)){
                        echo $row3['order_amount']."<br/>";
                        $allamount = $allamount + intval($row3['order_amount']);
                      } 
                      ?>
                  </td>
                  <td>
                      ...
                      $result3 = mysqli_query($con,"SELECT * FROM order_pro WHERE order_id = '$order_id'");
                      while($row3 = mysqli_fetch_assoc($result3)){
                        $sumprice = $row3['order_price']; echo number_format($sumprice)."<br/>";
                        $allprice = $allprice + $sumprice;
                      } 
                      ?>
                  </td>
                  <td><?php $time=$row['order_date']; echo Thai_date($time); ?></td>
                </tr>
                </form>
                <?php $count = $count + 1;} mysqli_close($con);?>
                
                </tbody>

                <tfoot>
                <tr>
                  <th>รายการสั่งซื้อสินค้า</th>
                  <th><?php echo $count; ?> รายการ</th>                  
                  <th>ยอดสั่งซื้อสินค้า</th>
                  <th></th>
                  <th><?php echo $allamount; ?> ชิ้น</th>
          ...
          <div class="container-fluid">
              ...
              <tr>
              <td>
              <strong>รายงานสรุปการส่งสินค้า <?php if($_POST['date'] != ""){ echo "ตั้งแต่วันที่ ".$_POST['date']; }?></strong>
              </td>
              </tr>
              </table>
             </div>
            ...
            <div class="card-body">
              <table id="example3" class="table table-bordered table-striped">
                ...
                include "connect.php";
                mysqli_set_charset($con,"utf8");
                if($_POST['date'] != ""){$result = mysqli_query($con,"SELECT * FROM sent_pro WHERE sent_date BETWEEN '$sdate' AND '$edate' group by sent_id");}else{
                $result = mysqli_query($con,"SELECT * FROM sent_pro group by sent_id");}
                while($row = mysqli_fetch_assoc($result)){
                ?>
                <form method='post' action=''>
                <tr>
                  ...
                  <td><?php echo $row['emp_id']; ?></td>
                  <td>
                      <?php $sent_id = $row['sent_id']; 
                      $result3 = mysqli_query($con,"SELECT * FROM sent_pro WHERE sent_id = '$sent_id'");
                      while($row3 = mysqli_fetch_assoc($result3)){
                        echo $row3['pro_id']."<br/>";
                      } 
                      ?>
                  ...
                  <td>
                      ...
                      $result3 = mysqli_query($con,"SELECT * FROM sent_pro WHERE sent_id = '$sent_id'");
                      while($row3 = mysqli_fetch_assoc($result3)){
                        echo $row3['sent_amount']."<br/>";
                        $allamount = $allamount + intval($row3['sent_amount']);
                      } 
                      ?>
                  </td>
                  <td><?php $time=$row['sent_date']; echo Thai_date($time); ?></td>
                </tr>
                </form>
                <?php $count = $count + 1;} mysqli_close($con);?>
